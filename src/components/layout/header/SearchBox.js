...
const AutoComplete = ({ suggestions }) => {
  ...
  return (
    <div className='fixed w-1/2 md:w-1/3 xl:w-1/6 top-16 right-0 md:right-24 xl:right-0 p-2 flex flex-col overflow-hidden py-1 bg-sub text-shadow-sm rounded-xl animate-shrink shadow-lg shadow-black'>
