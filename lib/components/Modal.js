...
const Modal = ({ className, children, onBackdrop, onClose, ...props }) => (
  <div className='fixed inset-0 p-6 bg-black-75 z-50' onClick={ onBackdrop }>
    <div className='flex justify-center items-center h-full'>
      <div
        { ...props }
        className={ clsx('relative flex flex-col items-stretch max-w-full max-h-full rounded-md bg-white', className) }
      >
